        ...
        <div class="w-100 flex-lg-row-fluid mx-lg-13">
            ...
            <div class="card card-flush mb-10">
                ...
                <div class="card-body pt-2 pb-0">
                    ...
                    <textarea class="form-control bg-transparent border-0 px-0" id="kt_social_feeds_post_input"
                        name="message" data-kt-autosize="true" rows="1" placeholder="Type your message..."></textarea>
                    <!--end::Input-->
                </div>
                <!--end::Body-->
                <!--begin::Footer-->
            ...
            <div class="mb-10" id="kt_social_feeds_posts">
                ...
                <div class="card card-flush mb-10">
                    ...
                    <div class="card-body">
                        <!--begin::Post content-->
                        <div class="fs-6 fw-normal text-gray-700 mb-5">There are two main approaches you can take to
                            writing amazing blog post headlines. You can either decide on your final headline before
                            outstanding you write the most of the rest of your creative post</div>
                        <!--end::Post content-->
                        <!--begin::Post media-->
                                ...
                                <div class="row g-7 h-250px h-md-375px">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <a class="d-block card-rounded overlay h-100"
                                            ...
                                            <!--begin::Image-->
                                            <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-100"
                                                style="background-image:url('assets/media/stock/600x400/img-79.jpg')">
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Action-->
                                            <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                ...
                <div class="card card-flush mb-10">
                    ...
                    <div class="card-body">
                        <!--begin::Post content-->
                        <div class="fs-6 fw-normal text-gray-700">You can either decide on your final headline before
                            outstanding you write the most of the rest of your creative post</div>
                        <!--end::Post content-->
                    </div>
                    <!--end::Card body-->
                            ...
                            <div class="collapse" id="kt_social_feeds_comments_2">
                                ...
                                <div class="d-flex pt-6">
                                    ...
                                    <div class="d-flex flex-column flex-row-fluid">
                                        ...
                                        <div class="d-flex align-items-center flex-wrap mb-0">
                                            <!--begin::Name-->
                                            <a href="#" class="text-gray-800 text-hover-primary fw-bold me-6">Alice
                                                Danchik</a>
                                            <!--end::Name-->
                                            <!--begin::Date-->
                ...
                <div class="card card-flush mb-10">
                    ...
                    <div class="card-header pt-9">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1">
                                <!--begin::Name-->
                                <a href="#" class="text-gray-800 text-hover-primary fs-4 fw-bold">Finance Deprt - Annual
                                    Report</a>
                                <!--end::Name-->
                                <!--begin::Date-->
                                <span class="text-gray-500 fw-semibold d-block">Yestarday at 5:06 PM</span>
                    ...
                    <div class="card-body">
                        <!--begin::Post content-->
                        <div class="fs-6 fw-normal text-gray-700 mb-5">You can either decide on your final headline
                            before outstanding you write the most of the rest of your creative post</div>
                        <!--end::Post content-->
                        <!--begin::Video-->
                        <div class="m-0">
                            ...
                            <div class="collapse" id="kt_social_feeds_comments_3">
                                ...
                                <div class="d-flex pt-6">
                                    ...
                                    <div class="d-flex flex-column flex-row-fluid">
                                        ...
                                        <div class="d-flex align-items-center flex-wrap mb-0">
                                            <!--begin::Name-->
                                            <a href="#" class="text-gray-800 text-hover-primary fw-bold me-6">Grace
                                                Green</a>
                                            <!--end::Name-->
                                            <!--begin::Date-->
                            ...
                            <div class="collapse" id="kt_social_feeds_comments_4">
                                ...
                                <div class="d-flex pt-6">
                                    ...
                                    <div class="d-flex flex-column flex-row-fluid">
                                        ...
                                        <div class="d-flex align-items-center flex-wrap mb-0">
                                            <!--begin::Name-->
                                            <a href="#" class="text-gray-800 text-hover-primary fw-bold me-6">Mat
                                                Dillon</a>
                                            <!--end::Name-->
                                            <!--begin::Date-->
                ...
                <div class="d-none" id="kt_social_feeds_more_posts">
                                    ...
                                    <div class="d-flex pt-6">
                                        ...
                                        <div class="d-flex flex-column flex-row-fluid">
                                            ...
                                            <span class="text-gray-800 fs-7 fw-normal pt-1">Long before you sit dow to
                                                put digital pen to paper you need to make sure you have to sit down and
                                                write.</span>
                                            <!--end::Text-->
                                        </div>
                                        <!--end::Wrapper-->
                    ...
                    <div class="card card-flush mb-10">
                        ...
                        <div class="card-body">
                            <!--begin::Post content-->
                            <div class="fs-6 fw-normal text-gray-700">You can either decide on your final headline
                                before outstanding you write the most of the rest of your creative post</div>
                            <!--end::Post content-->
                        </div>
                        <!--end::Card body-->
            ...
            <div class="d-none" id="kt_social_feeds_new_post">
                ...
                <div class="card card-flush mb-10">
                    ...
                    <div class="card-body">
                        <!--begin::Post content-->
                        <div class="fs-6 fw-normal text-gray-700" data-kt-post-element="content">You can either decide
                            on your final headline before outstanding you write the most of the rest of your creative
                            post</div>
                        <!--end::Post content-->
                    </div>
                    <!--end::Card body-->
        ...
        <div class="d-lg-flex flex-column flex-lg-row-auto w-lg-325px" data-kt-drawer="true"
            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bold text-gray-900">Sujestões</span>
